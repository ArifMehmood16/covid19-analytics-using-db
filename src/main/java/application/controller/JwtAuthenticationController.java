...
import application.authentication.JwtTokenUtils;
...
public class JwtAuthenticationController {
    ...
    public List<String> getLoggedInUsers() throws Exception {

        return userDetailsService.getUsersFromSessionRegistry();
    }
